...
model_path = os.path.join(os.path.curdir, "model", args.model_file)
test_path = os.path.join(os.path.curdir, "data", args.test_file)
output_path = os.path.join(os.path.curdir, "result", args.output_file)
gpu_config = "/gpu:"+str(args.gpu)
emb_path = args.char_emb
num_steps = 21  # consist with the train
