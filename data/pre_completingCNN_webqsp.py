...
labels = codecs.open('../../slot_filling/result/WebQSP.train.sf.processed', encoding='utf-8').readlines()
relations = codecs.open('../KG/WebQSP_relation.processed', encoding='utf-8').readlines()
target_x = codecs.open('WebQSPall-train.txt', mode='w', encoding='utf-8')
